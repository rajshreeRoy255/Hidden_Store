...
$ip = getIPAddress(); 
$sele="SELECT cart_details.quantity,cart_details.total_price,products.product_title,products.product_image1,products.product_price,products.product_id  FROM cart_details JOIN products ON cart_details.product_id=products.product_id WHERE ip_address='$ip' ";
